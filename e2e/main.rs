...
fn click_until(session: &Session, base: &str, selector: &str, from: &str, to: &str) {
    let script = format!(
...
fn press_escape_until(session: &Session, base: &str, from: &str, to: &str) {
...
fn settle(session: &Session, base: &str, script: &str, from: &str, to: &str, what: &str) {
